...
type CheckpointOptions struct {
	...
	ParenthPath         string   `protobuf:"bytes,11,opt,name=parenth_path,json=parenthPath,proto3" json:"parenth_path,omitempty"`
	Lazypages           bool     `protobuf:"varint,12,opt,name=lazypages,proto3" json:"lazypages,omitempty"`
}
...
func (m *CheckpointOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ParenthPath) > 0 {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintRunc(dAtA, i, uint64(len(m.ParenthPath)))
		i += copy(dAtA[i:], m.ParenthPath)
	}
	if m.Lazypages {
		dAtA[i] = 0x60
		i++
...
func (this *CheckpointOptions) String() string {
	...
	s := strings.Join([]string{`&CheckpointOptions{`,
		...
		`ParenthPath:` + fmt.Sprintf("%v", this.ParenthPath) + `,`,
		`Lazypages:` + fmt.Sprintf("%v", this.Lazypages) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CheckpointOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ParenthPath", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ParenthPath = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 12:
			if wireType != 0 {
...
var fileDescriptorRunc = []byte{
	...
	,
}
